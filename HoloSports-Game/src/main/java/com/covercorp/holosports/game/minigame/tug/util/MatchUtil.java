package com.covercorp.holosports.game.minigame.tug.util;
...
public final class MatchUtil {
    ...
    public static String getVersusBar(final ITugTeam team1, final ITugTeam team2) {
        final String indicator = "⬛";

        final ChatColor team1Color = ChatColor.valueOf(team1.getColor());
        final ChatColor team2Color = ChatColor.valueOf(team2.getColor());

        final String baseBar = "⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛";

        // The team that has more points will have more indicators
        final int team1Points = team1.getPoints();
        final int team2Points = team2.getPoints();
