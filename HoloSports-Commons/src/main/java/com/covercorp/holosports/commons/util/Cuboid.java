...
public final class Cuboid {
    ...
    public Cuboid(final Location startPoint, final Location endPoint) {
    ...
    public Cuboid(final World world, int x1, int y1, int z1, int x2, int y2, int z2) {
        this.world = world;
    ...
    public boolean containsCuboid(final Cuboid cuboid) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof final Cuboid cuboidComp)) return false;
